...
public class RenderTermsFilters{
    ...
    public RenderTermsFilters(JList[]jLists) {
        ...
        for (JList myList: jLists
            ...
            setJListCheckBoxFeatures(myList);
        }
    }

    private void setJListCheckBoxFeatures(JList myList) {
    ...
    public void setTagsJList(JList tagsJList, ArrayList<String> tagsName) {
        ...
        if(!isTagsTableRendered) {
            ...
            setJListCheckBoxFeatures(tagsJList);
